"""
Django settings for NIPPI project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, "nips/templates"),
            os.path.join(BASE_DIR, "receiver/templates"),
            os.path.join(BASE_DIR, "records/templates"),
            os.path.join(BASE_DIR, "siren/templates"),
...
WSGI_APPLICATION = 'NIPPI.wsgi.application'
